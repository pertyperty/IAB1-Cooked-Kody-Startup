    ...
    <section class="workspace-section">
        <div class="split-grid">
            <article class="surface inset-surface">
                ...
                <div id="preset-cards" class="catalog-list"></div>

                <h3>Leaderboard Snapshot</h3>
                <div id="gamification-leaderboard-table" class="table-wrap"></div>

                <h3>Weekly Challenge Queue</h3>
                <div id="weekly-table" class="table-wrap"></div>
                <div id="weekly-cards" class="catalog-list"></div>
            </article>
            ...
            <article class="surface inset-surface">
                <details class="advanced-drawer" open>
                    <summary>Weekly Challenge Operations</summary>
